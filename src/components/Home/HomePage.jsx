...
useEffect(() => {
  ...
  return (
    ...
    <div className="w-full min-h-screen flex flex-col items-center justify-center text-center px-4">
      {/* Conteúdo principal */}
      <div>
      <div id="inicio" className="flex flex-row gap-20 my-20">
        ...
        <div className="">
          <h6
          className="text-4xl font-bold mb-8 mt-3 animate-pulse bg-clip-text text-transparent
  ...
  dark:from-cyan-400 dark:via-purple-400 dark:to-pink-500"
      ...
      <div className="w-full h-[60vh] flex items-center justify-center bg-gray-100 dark:bg-gray-800 px-6 mx-9">
...
<section className="w-full flex flex-col items-center mt-16 px-4">
  ...
  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl">
    ...
    {/* Serviço 1 */}
    <div className="bg-gray-100 dark:bg-gray-800 p-6 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
