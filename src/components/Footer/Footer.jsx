  ...
  return (
    <footer className="footer-port">
      ...
      <div style={{ display: "flex", gap: 16, alignItems: "center" }}>
        <a href="https://github.com/laisfernandasales" target="_blank" rel="noopener noreferrer"
        ...
        <a href="https://www.linkedin.com/in/lais-fernanda-sales-melo/" target="_blank" rel="noopener noreferrer"
          style={{ color: "var(--port-muted)", transition: "color 0.2s" }}
          onMouseOver={e => e.currentTarget.style.color = "var(--port-cyan)"}
          onMouseOut={e  => e.currentTarget.style.color = "var(--port-muted)"}
        >
